<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('About') }}
            <span><a href="{{ url('abouts/create') }}"><button class="float-right text-blue-800">Add About</button></a></span>
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <table class="border-collapse w-full">
                    ...
                    <tr>
                        ...
                        <th class="p-3 font-bold uppercase bg-gray-200 text-gray-600 border border-gray-300 hidden lg:table-cell">About Image</th>
                    ...
                    @foreach($abouts as $about)
                        <tr class="bg-white lg:hover:bg-gray-100 flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="w-full lg:w-auto p-3 text-gray-800 border border-b text-center block lg:table-cell relative lg:static">
                                ...
                                <a href="{{ url('abouts/'.$about->id.'/edit') }}" class="text-blue-400 hover:text-blue-600 underline pl-6">Edit</a>
